                            ...
                            <tr class="border-t">
                                ...
                                <td>
                                    @if ($assignment->certificate)
                                        <a href="{{ route('certificates.verify', $assignment->certificate) }}" class="font-semibold text-[#1c6b84] underline underline-offset-2">{{ $assignment->certificate->certificate_number }}</a>
                                    @else
