...
<flux:tooltip :content="$text">
    <button type="button"
        {{ $attributes->merge(['class' => 'grid size-4 shrink-0 place-items-center rounded-full text-[#9aa3a9] transition hover:text-[#1c6b84] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ds-focus-ring)]']) }}
